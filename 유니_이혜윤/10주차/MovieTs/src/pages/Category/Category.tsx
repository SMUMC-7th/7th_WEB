  ...
  return (
    <div className="w-full h-full p-8 bg-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <Link to="/movie/now-playing" className="group">
        ...
        <Link to="/movie/popular" className="group">
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            <img
        ...
        <Link to="/movie/top-rated" className="group">
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            <img
        ...
        <Link to="/movie/up-coming" className="group">
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            <img
